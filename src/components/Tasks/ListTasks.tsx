...
const TaskList = ({ fieldTitle, filter }: TaskListProps) => {
    ...
    async function fetchTasks() {
      ...
      const toFilter: any = {
        ...
        updatedAt: today
          ...
          : undefined,
        // Add additional filters based on the URL parameters
        ...(lastThreeDays && {
          updatedAt: {
  ...
  return (
    <div className="mx-auto space-y-4">
      <TaskListHeader fieldTitle={fieldTitle} tasks={tasks} />
      {loading ? (
        <TaskListSkeleton />
      ) : tasks.length > 0 ? (
...
const TaskListHeader = ({ fieldTitle, tasks }: { fieldTitle: string; tasks: Task[] }) => (
